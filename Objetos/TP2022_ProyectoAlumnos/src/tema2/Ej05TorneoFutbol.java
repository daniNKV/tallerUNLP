...
public class Ej05TorneoFutbol {
    ...
    public static void main(String[] args) {
        int dimL = 0; 
        int dimF = 20;
        String codigoFin = "ZZZ";
        Partido campeonato[] = new Partido[20];
        
        Partido nuevoPartido = new Partido();
        
        System.out.print("Ingrese equipo visitante: ");
        nuevoPartido.setVisitante(Lector.leerString());
        
        while (codigoFin.equals(nuevoPartido.getVisitante()) && dimL < dimF) {
            campeonato[dimL] = new Partido();
            
            System.out.print("Ingrese goles equipo visitante: ");
            nuevoPartido.setGolesVisitante(Lector.leerInt());
            System.out.print("Ingrese equipo Local: ");
            nuevoPartido.setLocal(Lector.leerString());
            System.out.print("Ingrese goles del equipo local: ");
            nuevoPartido.setGolesLocal(Lector.leerInt());
            
            campeonato[dimL] = nuevoPartido;
